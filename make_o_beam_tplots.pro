...
;  ylim, [all_tplot_names.parallel_dispersion_estimated_distance_name, all_tplot_names.antiparallel_dispersion_estimated_distance_name], 0, 50, 0
  ...
  zlim, [all_tplot_names.diffflux_o1_parallel_name, all_tplot_names.diffflux_o1_antiparallel_name], 10, 10000, 1
  zlim, [all_tplot_names.parallel_pa_name,  all_tplot_names.antiparallel_pa_name], 10, 10000, 1
  ...
  var_label = [all_tplot_names.l_name, all_tplot_names.mlt_name, all_tplot_names.dist_name]
  ...
  IF ct GT 0 THEN BEGIN 
     FOR idisplay = 0, CEIL(t_dt/displaytime)-1 DO BEGIN 
        ...
        tplot, [all_tplot_names.beta_name  $
                , all_tplot_names.diffflux_h1_name, all_tplot_names.diffflux_h1_pa_name $ 
                , all_tplot_names.diffflux_o1_parallel_name, all_tplot_names.parallel_pa_name $
                , all_tplot_names.diffflux_o1_antiparallel_name, all_tplot_names.antiparallel_pa_name ], var_label = var_label
