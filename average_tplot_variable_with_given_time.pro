...
;+
; PROCEDURE: average_tplot_variable with the given average time array
;
...
PRO average_tplot_variable_with_given_time, var, average_time, time_avg, NEW_NAME = NEW_NAME, sumup = sumup
